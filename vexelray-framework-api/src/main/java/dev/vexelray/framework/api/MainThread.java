 ...
 *
 * <p>What the processor checks is one rule, in one direction: <b>a main-thread value may not be injected into
 * anything that is not itself main-thread.</b> A worker-safe component asking for a {@code GuiApp} is a
 * compile error naming both types, rather than a Vulkan call from a worker thread that happens to survive
